...
<ul id="cloud_list" style="padding: 0px; margin: 0px; list-style-type: none; color: rgb(204, 0, 0); display: none;">
...
<div class="list-div">
    <table cellspacing="1" cellpadding="3">
        ...
        <tr>
            ...
            <td width="30%">Apache/2.2.25 (Win32) PHP/5.3.29</td>
        </tr>
        <tr>
            <td>PHP 版本:</td>
            <td>5.3.29</td>
...
<script type="text/javascript" src="../../../Public/Admin/js/utils.js"></script><script type="Text/Javascript" language="JavaScript">
    <!--
    onload = function()
    {
        /* 检查订单 */
...
<div id="footer">
    共执行 29 个查询，用时 0.193993 秒，Gzip 已禁用，内存占用 3.511 MB<br>
