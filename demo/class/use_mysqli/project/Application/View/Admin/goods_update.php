...
<h1>
    ...
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 修改商品 </span>
        ...
        <form enctype="multipart/form-data" action="" method="post" name="theForm">
            ...
            <table width="90%" id="general-table" align="center">
                <tbody><tr>
                    ...
                    <td><input type="text" name="goods_name" value="<?php echo $goods_info['name']?>" style="float:left;color:;" size="30"><div style="background-color:;float:left;margin-left:2px;" id="font_color" onClick="ColorSelecter.Show(this);"><img src="/Public/Admin/images/color_selecter.gif" style="margin-top:-1px;"></div><input type="hidden" id="goods_name_color" name="goods_name_color" value="">&nbsp;
                ...
                <tr>
                    ...
                    <td><select name="cat_id" onChange="hideCatDiv()">
                            ...
                            <?php foreach($cat_list as $rows):?>
                                <option value="<?php echo $rows['id']?>" <?php echo $goods_info['categoryid']==$rows['id']?'selected':''?>><?php echo str_repeat('&nbsp;',$rows['deep']*4),$rows['name']?></option>
                            <?php endforeach;?>
                        </select>
              ...
              <input class="text" size="10" name="addedCategoryName">
               ...
               <a href="javascript:void(0)" onClick="hideCatDiv()" title="隐藏" class="special">&lt;&lt;</a>
                ...
                <tr>
                    ...
                    <td><input type="text" name="shop_price" value="<?php echo $goods_info['price']?>" size="20" onBlur="priceSetted()">
                        <input type="button" value="按市场价计算" onClick="marketPriceSetted()">
                        <span class="require-field">*</span></td>
                </tr>

                <!--鍟嗗搧浼樻儬浠锋牸-->          <!--鍟嗗搧浼樻儬浠锋牸 end -->
                <tr>
                    <td class="label">上传商品图片：</td>
                    <td>
                        <input type="file" name="goods_img" size="35">
                        <img src="/Public/Admin/images/no.gif"></td>
                </tr>
                </tbody></table>
            ...
            <table width="90%" id="mix-table"  align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="status[]" value="best" id="status[]" <?php echo strpos($goods_info['status'],'best')!==false?'checked':''?>>精品
                        <input type="checkbox" name="status[]" value="new" id="status[]" <?php echo strpos($goods_info['status'],'new')!==false?'checked':''?>>新品
                        <input type="checkbox" name="status[]" value="hot" id="status[]" <?php echo strpos($goods_info['status'],'hot')!==false?'checked':''?>>热销
                    </td>
                </tr>
                <tr>
                    <td class="label">商品简单描述：</td>
                    <td><textarea name="goods_desc" cols="40" rows="3" id="goods_desc"><?php echo $goods_info['goods_desc']?></textarea></td>
                </tr>
                </tbody></table>
            ...
            <div class="button-div">
                ...
                <input name="提交" type="submit" class="button" onClick="validate('0')" value=" 确定 ">
...
<div id="footer">
    共执行 9 个查询，用时 0.010464 秒，Gzip 已禁用，内存占用 3.271 MB<br>
...
-->
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://active.macromedia.com/flash2/cabs/swflash.cab#version=4,0,0,0" name="msgBeep" width="1" height="1" id="msgBeep">
