        ...
        <tbody><tr>
            ...
            <td style="padding-left: 50px">
                <table>
                    ...
                    <tr>
                        <td colspan="2" align="right"><img src="index.php?a=Admin&c=Login&a=generalCapcha" width="145" height="20" alt="CAPTCHA" border="1" onClick="this.src='index.php?a=Admin&c=Login&a=generalCapcha&'+Math.random()" style="cursor: pointer;" title="看不清？点击更换另一个验证码。">
                        </td>
                    </tr>
