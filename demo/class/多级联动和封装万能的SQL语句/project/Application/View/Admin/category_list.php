        ...
        <table width="100%" cellspacing="1" cellpadding="2" id="list-table">
            ...
            <?php foreach($list as $rows):?>
                <tr align="center" class="0" id="0_6">
                    <td align="left" class="first-cell" style="background-color: rgb(255, 255, 255); padding-left:<?php echo $rows['deep']*60?>px">
                        <img src="/Public/Admin/images/menu_minus.gif" id="icon_0_6" width="9" height="9" border="0" style="margin-left:0em" onClick="rowC licked(this)">
                        <span><?php echo $rows['name']?></span>
                    </td>
                    <td width="10%" align="right"><?php echo $rows['sort_order']?></td>
                    <td width="24%" align="center" style="background-color: rgb(255, 255, 255);">
                        <a href="index.php?p=Admin&c=Category&a=update&id=<?php echo $rows['id']?>">编辑</a> |
                        <a href="index.php?p=Admin&c=Category&a=del&id=<?php echo $rows['id']?>" onClick="return confirm('您确认要删除这条记录吗?')" title="移除">移除</a>
                    </td>
                </tr>
            <?php endforeach;?>
            </tbody></table>
...
<div id="footer">
    共执行 1 个查询，用时 0.005426 秒，Gzip 已禁用，内存占用 2.218 MB<br>
