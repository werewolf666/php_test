...
<h1>
    <span class="action-span"><a href="index.php?p=Admin&c=Category&a=list">商品分类</a></span>
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1"> - 更新分类 </span>
    ...
    <form action="" method="post" name="theForm" enctype="multipart/form-data" onSubmit="return validate()">
        <table width="100%" id="general-table">
            <tbody><tr>
                ...
                <td>
                    <input type="text" name="cat_name" maxlength="20" value="<?php echo $info['name']?>" size="27"> <font color="red">*</font>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php foreach($list as $rows):?>
                            <option value="<?php echo $rows['id']?>" <?php if($info['parent_id']==$rows['id']) echo 'selected'?>><?php echo str_repeat('&nbsp;',$rows['deep']*4),$rows['name']?></option>
                        <?php endforeach;?>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" name="sort_order" value="<?php echo $info['sort_order']?>" size="15">
                </td>
            </tr>
            </tbody></table>
...
<div id="footer">
    共执行 3 个查询，用时 0.008914 秒，Gzip 已禁用，内存占用 2.283 MB<br>
