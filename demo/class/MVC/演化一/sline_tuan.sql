...
CREATE TABLE `sline_tuan` (
  ...
  `content` longtext COMMENT '团购内容介绍',
  ...
  `dingjin` decimal(11,2) DEFAULT NULL,
  ...
  `limit_order` smallint(5) unsigned NOT NULL DEFAULT '0' COMMENT '团购购买数量限制',
  PRIMARY KEY (`id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='团购表';-- <xjx> --
