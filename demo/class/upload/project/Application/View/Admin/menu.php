    ...
    <div id="menu-list">
        <ul id="menu-ul">
            <li class="explode" key="02_cat_and_goods" name="menu">
                商品管理        <ul>
                    <li class="menu-item"><a href="index.php?p=admin&c=goods&a=list" target="main-frame">商品列表</a></li>
                    <li class="menu-item"><a href="index.php?p=admin&c=goods&a=add" target="main-frame">添加新商品</a></li>
                    <li class="menu-item"><a href="index.php?p=admin&c=category&a=list" target="main-frame">商品分类</a></li>
...
<script type="text/javascript" src="../../../Public/Admin/js/global.js"></script><script type="text/javascript" src="../../../Public/Admin/js/utils.js"></script><script language="JavaScript">
    <!--
    var collapse_all = "闭合";
    var expand_all = "展开";
    var collapse = true;
