<html xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <script type="text/javascript" src="../../../Public/Admin/js/transport.js"></script><script type="text/javascript">
        onload = function()
        {
...
<div id="header-div">
    ...
    <div id="submenu-div">
        ...
        <div id="load-div" style="padding: 5px 10px 0px 0px; text-align: right; color: rgb(255, 153, 0); display: none; width: 40%; float: right;"><img src="../../../Public/Admin/images/top_loader.gif" width="16" height="16" alt="正在处理您的请求..." style="vertical-align: middle"> 正在处理您的请求...</div>
    </div>
</div>
<div id="menu-div">
    <ul>
