        ...
        <form enctype="multipart/form-data" action="" method="post" name="theForm">
                ...
                <tr>
                    ...
                    <td><select name="cat_id" onChange="hideCatDiv()">
                            ...
                            <?php foreach($cat_list as $rows):?>
                                <option value="<?php echo $rows['id']?>"><?php echo str_repeat('&nbsp;',$rows['deep']*4),$rows['name']?></option>
                            <?php endforeach;?>
                        </select>
              ...
              <input class="text" size="10" name="addedCategoryName">
               ...
               <a href="javascript:void(0)" onClick="hideCatDiv()" title="隐藏" class="special">&lt;&lt;</a>
                ...
                <tr>
                    ...
                    <td>
                        <input type="file" name="goods_img" size="1000000">
                        <img src="/Public/Admin/images/no.gif">
                        <br><input type="text" size="1000000" value="商品图片外部URL" style="color:#aaa;" onFocus="if (this.value == '商品图片外部URL'){this.value='http://';this.style.color='#000';}" name="goods_img_url">
                    </td>
                </tr>
                </tbody></table>
            ...
            <table width="90%" id="mix-table"  align="center">
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="status[]" value="best" id="status[]">精品
                        <input type="checkbox" name="status[]" value="new" id="status[]">新品
                        <input type="checkbox" name="status[]" value="hot" id="status[]">热销
                    </td>
                </tr>
                <tr>
                    <td class="label">商品简单描述：</td>
                    <td><textarea name="goods_desc" cols="40" rows="3" id="goods_desc"></textarea></td>
                </tr>
                </tbody></table>
