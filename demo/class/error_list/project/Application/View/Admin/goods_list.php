        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php foreach($list as $rows):?>
                <tr>
                    ...
                    <td align="center" style="background-color: rgb(255, 255, 255);"><a href="index.php?p=admin&c=goods&a=modify&goodsid=<?php echo $rows['goodsid']?>" title="编辑"><img src="/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0"></a><a href="index.php?p=admin&c=goods&a=del&goodsid=<?php echo $rows['goodsid']?>" onClick="return confirm('您确实要删除该商品吗？')" title="删除"><img src="/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0"></a></td>
                </tr>
            <?php endforeach;?>
            </tbody></table>
        <!-- end goods list -->
            ...
            <tbody><tr>
                <td align="right" nowrap="true">
                    ...
                    <div id="turn-page">
                        ...
                        个记录分为 <span id="totalPages"><?php echo $pagecount ?></span>
                        页当前第 <span id="pageCurrent"><?php echo $pageno ?></span>
                        页，每页 <input type="text" size="3" id="pageSize" value="15" onKeyPress="return listTable.changePageSize(event)">
                        <span id="page-link">
          <a href="index.php?p=admin&c=goods&a=list&pageno=1">第一页</a>
          <a href="index.php?p=admin&c=goods&a=list&pageno=<?php echo $pageno-1?>">上一页</a>
          <a href="index.php?p=admin&c=goods&a=list&pageno=<?php echo $pageno+1?>">下一页</a>
          <a href="index.php?p=admin&c=goods&a=list&pageno=<?php echo $pagecount ?>">最末页</a>
